-- Fix search_path for batch update functions
DROP FUNCTION IF EXISTS update_global_topics_order(jsonb);
DROP FUNCTION IF EXISTS update_global_resources_order(jsonb);
