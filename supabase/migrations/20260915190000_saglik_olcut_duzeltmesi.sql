-- ============================================================================
-- Sağlık ölçütü: "panelde yabancı ders" ölçütü gerçeğe çekiliyor
-- ============================================================================
-- Bu ölçüt bir veri durumunu sayıyor: öğrencinin eski öğretmeninde kalan
-- işlenmiş dersler. Öğrenci panelinin öğretmen filtresi geldikten sonra bu
-- dersler artık kimseye yanlış görünmüyor — yani "kritik" değiller. Kayıt
-- (enrollment) modeli geldiğinde (Faz 6) tamamen ortadan kalkacaklar.
--
-- Ölçütü kritik bırakmak, deploy sonrası tablonun hep kırmızı görünmesine ve
-- gerçek bir sorun sanılmasına yol açardı.
--
-- Gövde, veritabanındaki tanımın birebir kopyasıdır (pg_get_functiondef).
