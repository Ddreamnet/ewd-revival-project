...
export function TestimonialsSection() {
  ...
  return (
    <section
      id="testimonials"
      className="ewd-bulge-host scroll-section relative px-5 py-20 sm:px-8 md:py-24 lg:py-[100px]"
    ...
    >
      ...
      <span
        ...
        style={{ backgroundImage: "url(/ewd/pat/b.png)", backgroundSize: "941px 1672px" }}
        aria-hidden="true"
      />
      ...
      <div className="relative mx-auto grid max-w-[1180px] items-center gap-12 lg:grid-cols-[396px_1fr] lg:gap-14">
        ...
        <div className="flex flex-col items-start gap-4">
          ...
          <div
            className="mt-3 flex items-center gap-4 rounded-full py-3.5 pl-4 pr-7"
            style={{
              background: "#FFFDF8",
        ...
        <div className="relative">
          <div className="relative h-[400px] sm:h-[360px] lg:h-[330px]">
            {items.map((item, i) => {
