          ...
          <div className="flex-col items-center gap-4 flex md:items-center justify-start">
            ...
            <div className="flex flex-col items-center gap-2.5 mt-1">
              ...
              <a
                ...
                className="group relative flex items-center gap-3 rounded-xl bg-[#1a1a2e] px-5 py-2.5 min-w-[200px] hover:bg-[#2a2a3e] transition-colors duration-200 cursor-pointer opacity-80 hover:opacity-100"
              ...
              >
                ...
                <div className="flex flex-col leading-tight">
                  ...
                  <span className="text-[15px] font-semibold text-white -mt-0.5">Google Play</span>
                </div>
                {/* Coming soon overlay */}
                <span className="absolute -top-2 -right-2 bg-landing-pink text-[9px] font-bold text-[#4A2040] px-2 py-0.5 rounded-full shadow-sm">
              ...
              >
                ...
                <div className="flex flex-col leading-tight">
                  ...
                  <span className="text-[15px] font-semibold text-white -mt-0.5">App Store</span>
                </div>
                {/* Coming soon overlay */}
                <span className="absolute -top-2 -right-2 bg-landing-pink text-[9px] font-bold text-[#4A2040] px-2 py-0.5 rounded-full shadow-sm">
                  {t.footer.comingSoon[language]}
