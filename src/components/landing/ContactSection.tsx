...
export function ContactSection() {
  ...
  const whatsappMessage = language === "tr" ? "Merhaba, ücretsiz deneme dersi hakkında bilgi almak istiyorum." : "Hello, I would like to get information about the free trial lesson.";
  ...
  const whyItems = [t.contact.whyCard.items.personalProgram, t.contact.whyCard.items.oneOnOne, t.contact.whyCard.items.tracking, t.contact.whyCard.items.freeTrial];
  const ageOptions = [{
    value: "myself",
  ...
  return <section id="contact" className="scroll-section pt-16 md:pt-24 pb-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-[12px]">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-3 px-6 py-4 bg-landing-yellow text-foreground rounded-2xl font-medium text-lg hover:bg-landing-yellow/80 transition-colors shadow-lg">
            <img src={whatsappLogo} alt="WhatsApp" className="w-6 h-6" />
            {t.contact.whatsapp[language]}
          </a>
          <a href={instagramLink} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-3 px-6 py-4 bg-landing-pink text-foreground rounded-2xl font-medium text-lg hover:bg-landing-pink/80 transition-colors shadow-lg">
        ...
        <div className="grid lg:grid-cols-3 gap-6 lg:gap-8 items-end">
          ...
          <div className="flex flex-col justify-center space-y-4">
            ...
            <div className="hidden lg:block bg-landing-purple/20 backdrop-blur-sm rounded-2xl p-5 shadow-lg">
              ...
              <ul className="space-y-2">
                {whyItems.map((item, index) => <li key={index} className="flex items-center gap-2">
            ...
            <div className="bg-pink-300/80 rounded-[20px] p-3 shadow-lg">
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-[16px] p-4">
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  {/* Sarı Gönder Butonu */}
                  <button type="submit" className="w-full h-10 rounded-xl font-bold text-amber-900
          ...
          <div className="hidden lg:flex items-end justify-end overflow-hidden">
            <img src="/uploads/dilarateacher.png" alt="Dilara Teacher" className="w-48 h-auto md:w-64 lg:w-80 xl:w-96 object-contain drop-shadow-xl" />
          </div>
        </div>
      </div>
    </section>;
