...
export function ContactSection() {
  ...
  const instagramLink = 'https://instagram.com/englishwithdilara';
  ...
  return (
    <section
      id="contact"
      className="scroll-section py-16 md:py-24 pb-safe"
    >
        ...
        <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-landing-purple/20 backdrop-blur-sm rounded-2xl p-5 shadow-lg">
              <h3 className="text-lg font-bold text-landing-purple-dark mb-4">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button
                  type="submit"
                  className="w-full bg-landing-purple hover:bg-landing-purple-dark text-white"
                >
