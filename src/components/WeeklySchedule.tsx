...
interface WeeklyScheduleProps {
  /** Ekran görünürken veri çekilir; sekme kapalıyken istek atılmaz. */
  active: boolean;
  teacherId: string;
}
...
/**
 * Haftalık ders programı — öğretmen panelinin "Derslerim" sekmesi.
 * Eskiden bir dialog'du; panel v2'de sekme olduğu için kabuk kaldırıldı,
      ...
      <div>
        <div>
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <h2 className="text-xl font-black tracking-[-0.02em]" style={{ color: "var(--ewd-on-surface)" }}>Haftalık Ders Programı</h2>
