  ...
  kidsPackages: {
    ...
    classicPackage: {
      ...
      items: {
        ...
        duration: {
          tr: "Dijital ekran süresine uygun 30 dakikalık dersler",
          en: "30-minute lessons designed for healthy screen time",
        },
    ...
    schoolPackage: {
      ...
      items: {
        parallel: {
          tr: "Okulda işlenen İngilizce konularıyla paralel ilerleme",
          en: "Progress in line with school English topics",
        },
        ...
        support: {
          tr: "Gerektiğinde temel İngilizce çalışmalarıyla okulu destekleme",
          en: "Extra core English practice when needed to support schoolwork",
        },
    ...
    adultPackage: {
      ...
      items: {
        ...
        everyday: {
          ...
          en: "English for everyday life and the workplace",
        },
        work: { tr: "İş hayatına özel programlar", en: "Work-focused programmes" },
        duration: {
          tr: "1 saatlik dersler, gün ve saatleri iş saatlerinize uygun şekilde planlanır",
          en: "60-minute lessons, scheduled to fit around your working hours",
        },
        options: { tr: "Birebir ve Grup ders seçeneği", en: "One-to-one and group lesson options" },
      },
    },
  ...
  faq: {
    ...
    questions: {
      duration: {
        ...
        answer: {
          tr: "Çocuk dersleri 30 dakika, yetişkin dersleri 60 dakikadır.",
          en: "Children's lessons are 30 minutes, adult lessons are 60 minutes.",
        },
      },
      freeTrial: {
        question: { tr: "Ücretsiz deneme dersi var mı?", en: "Is there a free trial lesson?" },
        answer: {
          tr: "Evet, tüm yeni öğrenciler için ücretsiz deneme dersi sunuyoruz.",
          en: "Yes, we offer a free trial lesson for all new students.",
        },
      },
      platform: {
        question: { tr: "Dersler hangi platformda yapılıyor?", en: "Which platform are the lessons held on?" },
        answer: {
          tr: "Tüm dersler Zoom üzerinden canlı olarak yapılmaktadır.",
          en: "All lessons are held live on Zoom.",
        },
      },
      lessonType: {
        ...
        subItems: {
          ...
          group: {
            tr: "Grup dersleri (maksimum 5 kişilik, aynı seviyedeki öğrencilerle)",
            en: "Group lessons (up to 5 students, at the same level)",
          },
        },
      },
      login: {
